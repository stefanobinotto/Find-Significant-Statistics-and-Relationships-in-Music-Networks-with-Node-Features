...
+-------------------------------------------------+
|   Artist Collaboration Network - United States  |
+-------------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ au-artist_network-2017.csv ║ Artist Network (edge list) for USA in 2017.       ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ au-artist_network-2018.csv ║ Artist Network (edge list) for USA in 2018.       ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ au-artist_network-2019.csv ║ Artist Network (edge list) for USA in 2019.       ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
