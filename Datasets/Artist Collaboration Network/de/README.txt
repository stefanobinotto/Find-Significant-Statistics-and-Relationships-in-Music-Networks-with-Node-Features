...
+---------------------------------------------+
|    Artist Collaboration Network - Germany	  |
+---------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ de-artist_network-2017.csv ║ Artist Network (edge list) for Germany in 2017.   ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ de-artist_network-2018.csv ║ Artist Network (edge list) for Germany in 2018.   ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ de-artist_network-2019.csv ║ Artist Network (edge list) for Germany in 2019.   ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
