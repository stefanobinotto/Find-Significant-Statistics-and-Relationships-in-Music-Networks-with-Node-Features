...
+---------------------------------------------+
|    Artist Collaboration Network - Brazil	  |
+---------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ br-artist_network-2017.csv ║ Artist Network (edge list) for Brazil in 2017.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ br-artist_network-2018.csv ║ Artist Network (edge list) for Brazil in 2018.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ br-artist_network-2019.csv ║ Artist Network (edge list) for Brazil in 2019.    ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
