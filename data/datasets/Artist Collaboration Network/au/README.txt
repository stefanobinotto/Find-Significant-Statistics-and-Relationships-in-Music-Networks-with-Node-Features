...
+-------------------------------------------------+
|    Artist Collaboration Network - Australia	  |
+-------------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ au-artist_network-2017.csv ║ Artist Network (edge list) for Australia in 2017. ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ au-artist_network-2018.csv ║ Artist Network (edge list) for Australia in 2018. ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ au-artist_network-2019.csv ║ Artist Network (edge list) for Australia in 2019. ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
