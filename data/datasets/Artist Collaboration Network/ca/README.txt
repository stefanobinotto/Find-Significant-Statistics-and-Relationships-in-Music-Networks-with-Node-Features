...
+---------------------------------------------+
|    Artist Collaboration Network - Canada	  |
+---------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ ca-artist_network-2017.csv ║ Artist Network (edge list) for Canada in 2017.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ ca-artist_network-2018.csv ║ Artist Network (edge list) for Canada in 2018.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ ca-artist_network-2019.csv ║ Artist Network (edge list) for Canada in 2019.    ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
