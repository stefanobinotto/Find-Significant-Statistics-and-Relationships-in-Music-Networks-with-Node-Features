...
+-----------------------------------------------------+
|    Artist Collaboration Network - United Kingdom	  |
+-----------------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ gb-artist_network-2017.csv ║ Artist Network (edge list) for UK in 2017.        ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ gb-artist_network-2018.csv ║ Artist Network (edge list) for UK in 2018.        ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ gb-artist_network-2019.csv ║ Artist Network (edge list) for UK in 2019.        ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
