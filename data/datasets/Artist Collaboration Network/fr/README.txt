...
+-------------------------------------------------+
|    Artist Collaboration Network - France	      |
+-------------------------------------------------+
...
║                                      FILES                                     ║
╠════════════════════════════╦═══════════════════════════════════════════════════╣
║ fr-artist_network-2017.csv ║ Artist Network (edge list) for France in 2017.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ fr-artist_network-2018.csv ║ Artist Network (edge list) for France in 2018.    ║
╠════════════════════════════╬═══════════════════════════════════════════════════╣
║ fr-artist_network-2019.csv ║ Artist Network (edge list) for France in 2019.    ║
╚════════════════════════════╩═══════════════════════════════════════════════════╝
